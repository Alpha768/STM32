...
#define RCC_APB1ENR_I2C1   	  ((unsigned long)0x00200000)
#define RCC_APB1ENR_I2C2   	  ((unsigned long)0x00400000)
...
#define RCC_APB2ENR_SPI1    ((unsigned long)0x00001000)
...
#define ACR_LATENCY_Mask         ((unsigned long)0x00000038)
#define ACR_HLFCYA_Mask          ((unsigned long)0xFFFFFFF7)
#define ACR_PRFTBE_Mask          ((unsigned long)0xFFFFFFEF)

/* Flash Access Control Register bits */
#define ACR_PRFTBS_Mask          ((unsigned long)0x00000020) 
...
#define CR_MER_Set               ((unsigned long)0x00000004)
#define CR_MER_Reset             ((unsigned long)0x00001FFB)
#define CR_OPTPG_Set             ((unsigned long)0x00000010)
#define CR_OPTPG_Reset           ((unsigned long)0x00001FEF)
#define CR_OPTER_Set             ((unsigned long)0x00000020)
#define CR_OPTER_Reset           ((unsigned long)0x00001FDF)
#define CR_STRT_Set              ((unsigned long)0x00000040)
#define CR_LOCK_Set              ((unsigned long)0x00000080)

/* FLASH Mask */
#define RDPRT_Mask               ((unsigned long)0x00000002)
#define WRP0_Mask                ((unsigned long)0x000000FF)
#define WRP1_Mask                ((unsigned long)0x0000FF00)
#define WRP2_Mask                ((unsigned long)0x00FF0000)
#define WRP3_Mask                ((unsigned long)0xFF000000)

/* FLASH Keys */
#define RDP_Key                  ((unsigned short)0x00A5)
#define FLASH_KEY1               ((unsigned long)0x45670123)
#define FLASH_KEY2               ((unsigned long)0xCDEF89AB)

/* Delay definition */   
#define EraseTimeout             ((unsigned long)0x00000FFF)
#define ProgramTimeout           ((unsigned long)0x0000000F)
...
#define  UID_BASE ((u32)0x1FFFF7E8)
#define UniqueID             ((UID_TypeDef *) UID_BASE)
