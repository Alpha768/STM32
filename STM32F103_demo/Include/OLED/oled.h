...
/*--------------------引脚定义--------------------------*/
#define 		OLED_SCLK_Set()			SetPortBit(PORTA,5)//GPIOA->BSRR = GPIO_Pin_5//GPIO_SetBits(GPIOA,GPIO_Pin_5)	//PA5（SCL）输出高
#define			OLED_SCLK_Clr()			ClrPortBit(PORTA,5)//GPIOA->BRR  = GPIO_Pin_5//GPIO_ResetBits(GPIOA,GPIO_Pin_5)	//PA5（SCL）输出低
#define			OLED_SDIN_Set()			SetPortBit(PORTA,7)//GPIOA->BSRR = GPIO_Pin_7//GPIO_SetBits(GPIOA,GPIO_Pin_7)	//PA7（SDA）输出高
#define			OLED_SDIN_Clr()			ClrPortBit(PORTA,7)//GPIOA->BRR  = GPIO_Pin_7//GPIO_ResetBits(GPIOA,GPIO_Pin_7)	//PA7（SDA）输出高
#define 		OLED_READ_SDIN()		GetPortBit(PORTA,7)//(GPIOA->IDR  & GPIO_Pin_7)//GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_7)	//读取PA7（SDA）电平
