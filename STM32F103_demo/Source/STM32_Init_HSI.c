...
#define __RCC_CR_VAL               0x01040083
...
#define __TIMER_INTERRUPTS        0x0009                  //  3
...
unsigned int stm32_GetSYSCLK(void)
{
	return ((unsigned int)__SYSCLK);
}
