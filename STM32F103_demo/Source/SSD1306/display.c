...
{
	drvSSD1306_DrawFilledCircle(5,2,4,SSD1306_COLOR_WHITE);
...
{
     drvSSD1306_Fill(SSD1306_COLOR_BLACK);
     drvSSD1306_GotoXY (x , y);
     drvSSD1306_Puts(data , &Font_7x10 , color == DISPLAY_BLUE_COLOR ? SSD1306_COLOR_WHITE : SSD1306_COLOR_BLACK);
     drvSSD1306_UpdateScreen();
}
