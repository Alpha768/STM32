...
/* Configuration 1 */
  ...
  WBVAL(                             /* wTotalLength */
	...
	1*USB_INTERFACE_DESC_SIZE     +  /* printer interface */
...
//****************************************************************************************
/* Interface 0, Alternate Setting 0, Printer Class */
  USB_INTERFACE_DESC_SIZE,           /* bLength */
  USB_INTERFACE_DESCRIPTOR_TYPE,     /* bDescriptorType */
  0x00,                   				 /* bInterfaceNumber: Number of Interface */
  0x00,                              /* bAlternateSetting: Alternate setting */
  0x06,                              /* bNumEndpoints: One endpoint used */
  0x07, 							 /* bInterfaceClass: printers Base Class */
  0x01,        						 /* bInterfaceSubClass: Printer devices */
  0x02,                              /* bInterfaceProtocol: no protocol used */
  0x04,                              /* iInterface: */
